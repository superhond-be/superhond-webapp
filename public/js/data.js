...
function loadDB(){ 
  try{ 
    return JSON.parse(localStorage.getItem(KEY)) || {
      ...
      lessen:[
        {id:'ls1',naamId:'nm1',typeId:'tp1',locatieId:'loc1',themaId:'th1',trainerIds:['tr1'],datum:'2025-10-01',tijd:'10:00',eindtijd:'11:00',capaciteit:8},
        {id:'ls2',naamId:'nm2',typeId:'tp1',locatieId:'loc2',themaId:'th2',trainerIds:['tr2','tr3'],datum:'2025-10-04',tijd:'11:00',eindtijd:'12:00',capaciteit:10}
      ]
    }; 
  } catch(e){ 
    return {}; 
