...
const {
  read: readEnroll,
  write: writeEnroll,      // (wordt nu niet gebruikt, maar laten staan voor toekomst)
  markMailSent,
  markActive
} = require('../helpers/publicEnrollments');
const {
  readCustomers, writeCustomers,
  readDogs, writeDogs, uid
...
Team Superhond`;
    ...
    // registreer dat mail is verzonden
    markMailSent(enrollment_id);
...
router.post('/complete', (req, res) => {
  ...
  // enrollment updaten → actief + timestamp
  markActive(payload.enrollment_id);
